...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-R1zX0ZOY.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-CRvJwpEG.js").then((n) => n.au),
    import("./vendor-@tanstack-react-start-BLlJhsyA.js").then((n) => n.a),
