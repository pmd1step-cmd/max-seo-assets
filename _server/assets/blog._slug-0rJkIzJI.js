...
import { Send, Check, Link2, X, ChevronRight, ArrowLeft, Clock, Eye, ListOrdered } from "lucide-react";
import { l as cn, ai as Route, aj as blogPostBySlugQuery, ak as relatedPostsQuery, s as supabase, B as Button } from "./router-C7PFiMKM.js";
import { s as slugify } from "./slugify-DPRENmKe.js";
import { toast } from "sonner";
import { B as BlogCard } from "./BlogCard-BsRLzmQP.js";
...
function BlogPostPage() {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-[1280px] px-4 py-10 md:px-8 md:py-14", children: [
      ...
      /* @__PURE__ */ jsxs("nav", { "aria-label": "Хлебные крошки", className: "mb-6 flex flex-wrap items-center gap-1.5 text-sm text-muted-foreground", children: [
        /* @__PURE__ */ jsx(Link, { to: "/", className: "hover:text-foreground", children: "Главная" }),
        /* @__PURE__ */ jsx(ChevronRight, { size: 14, className: "opacity-50" }),
        /* @__PURE__ */ jsx(Link, { to: "/blog", className: "hover:text-foreground", children: "Блог" }),
        /* @__PURE__ */ jsx(ChevronRight, { size: 14, className: "opacity-50" }),
        /* @__PURE__ */ jsx("span", { className: "line-clamp-1 text-foreground", children: post.title })
      ] }),
