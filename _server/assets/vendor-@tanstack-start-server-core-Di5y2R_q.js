...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-DLdByvzZ.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-2Odo1qEB.js").then((n) => n.av),
    import("./vendor-@tanstack-react-start-zjnD63rx.js").then((n) => n.a),
