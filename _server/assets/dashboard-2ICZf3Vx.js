...
import { Clock, XCircle, CheckCircle2, Eye, EyeOff, Loader2, Camera, Save, Plus, ImageIcon, Pencil, Trash2, Inbox, Mail, Phone, MessageSquare, Star, ExternalLink, Edit, AlertTriangle } from "lucide-react";
import { U as mySpecialistQuery, c as categoriesQuery, V as mySpecialistCategoryIdsQuery, s as supabase, B as Button, W as myCasesQuery, X as myApplicationsQuery, Y as myReviewsQuery, Z as myBlogPostsQuery, _ as Route } from "./router-CU9EeC6X.js";
import { T as Tabs, a as TabsList, b as TabsTrigger, c as TabsContent } from "./tabs-DxvaGK1J.js";
import { R as Reveal } from "./reveal-C2VFqomf.js";
import { toast } from "sonner";
import { I as Input } from "./input-D9qVVM7e.js";
import { T as Textarea } from "./textarea-C-NwCKoH.js";
import { L as Label } from "./label-CQUfrnuH.js";
import { S as Switch } from "./switch-BVuhKYep.js";
import { C as Checkbox } from "./checkbox-DXQCui_6.js";
import { d as deleteFromBucket, u as uploadToBucket } from "./RichTextEditor-u5TNAQi5.js";
import { s as slugify } from "./slugify-DPRENmKe.js";
import { A as AlertDialog, a as AlertDialogContent, b as AlertDialogHeader, c as AlertDialogTitle, d as AlertDialogDescription, e as AlertDialogFooter, f as AlertDialogCancel, g as AlertDialogAction, h as AlertDialogTrigger } from "./alert-dialog-B_Ivp5I2.js";
import { C as CaseEditor } from "./CaseEditor-BO5vIfsm.js";
import { formatDistanceToNow } from "date-fns";
import { ru } from "date-fns/locale";
import { S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem } from "./select-BPeIR1PJ.js";
import { B as Badge } from "./badge-D0p_e5pb.js";
import { B as BlogPostEditor } from "./BlogPostEditor-B6D-0qX6.js";
...
function ProfileTab({ userId }) {
  ...
  const handleFile = async (e) => {
    ...
    try {
      ...
      const seoBase = `avatar-${spec.slug || spec.name || spec.brand_name || "user"}`;
      const url = await uploadToBucket("avatars", userId, file, "", seoBase);
...
const StatsTab = lazy(() => import("./StatsTab-BhHp8nTO.js").then((m) => ({
  default: m.StatsTab
})));
