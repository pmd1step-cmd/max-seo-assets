...
import { H3Event, toResponse, sanitizeStatusCode, sanitizeStatusMessage, parseCookies, setCookie } from "h3-v2";
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-CuQ6SINk.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-DuTJZkD0.js").then((n) => n.ax),
