...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-CtoxM3sj.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-CtIgQZLw.js").then((n) => n.av),
    import("./vendor-@tanstack-react-start-D10SfLuI.js").then((n) => n.a),
