...
import { c as categoriesQuery, k as caseTagsQuery, a0 as caseCategoryIdsQuery, a1 as caseTagIdsQuery, a2 as caseMediaQuery, s as supabase, a3 as Dialog, a4 as DialogContent, a5 as DialogHeader, a6 as DialogTitle, a7 as DialogDescription, B as Button } from "./router-CU9EeC6X.js";
...
import { d as deleteFromBucket, u as uploadToBucket, R as RichTextEditor } from "./RichTextEditor-u5TNAQi5.js";
...
function CaseEditor({
  ...
  const handleCover = async (e) => {
    ...
    try {
      ...
      const url = await uploadToBucket("case-media", userId, file, "cover-", title || "case");
      setCoverUrl(url);
      if (isEdit) {
