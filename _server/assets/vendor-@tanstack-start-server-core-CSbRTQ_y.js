...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-DOGw2CNw.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-B8WkfRFF.js").then((n) => n.av),
    import("./vendor-@tanstack-react-start-BdAh7e7t.js").then((n) => n.a),
