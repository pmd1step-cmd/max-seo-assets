...
import { c as categoriesQuery, Q as categoryCountsQuery, T as featuredSpecialistsQuery, a as servicesQuery, u as useLeadRequest, B as Button } from "./router-DJFIfEch.js";
import { S as SpecialistCard } from "./SpecialistCard-BvyUR_g_.js";
import "react";
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsxs("section", { className: "relative overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-[1280px] px-4 py-20 text-center md:px-8 md:py-32", children: [
        ...
        /* @__PURE__ */ jsxs(Reveal, { as: "h1", delay: 100, y: 20, className: "mt-6 text-4xl font-extrabold leading-tight md:text-6xl lg:text-7xl", children: [
