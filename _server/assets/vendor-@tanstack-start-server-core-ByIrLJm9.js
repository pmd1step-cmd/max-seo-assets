...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-Bbl2eaFd.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-CIxMIIsp.js").then((n) => n.av),
    import("./vendor-@tanstack-react-start-DjHbPMm7.js").then((n) => n.a),
