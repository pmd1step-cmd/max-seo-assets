...
import { d as Route, c as categoriesQuery, e as slugsToIds, f as catalogQuery, P as PER_PAGE, B as Button } from "./router-DeAkxk-P.js";
...
function SpecialistsIndexPage() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-[1280px] px-4 py-10 md:px-8 md:py-14", children: [
    /* @__PURE__ */ jsxs("nav", { className: "mb-4 text-sm text-muted-foreground", children: [
      ...
      /* @__PURE__ */ jsx("span", { className: "text-foreground", children: "Специалисты" })
    ] }),
