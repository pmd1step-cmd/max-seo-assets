...
import { v as useAuth, w as myFavoriteIdsQuery, x as removeFavorite, y as addFavorite } from "./router-B7Hwdn-P.js";
...
function SpecialistCard({ specialist }) {
  ...
  return /* @__PURE__ */ jsxs(Reveal, { className: "group relative overflow-hidden rounded-2xl glass transition-shadow hover:shadow-elevated", children: [
