...
import { o as blogCategoriesQuery, p as blogTagsQuery, a9 as postTagIdsQuery, aa as adminSpecialistsQuery, s as supabase, a4 as Dialog, a5 as DialogContent, a6 as DialogHeader, a7 as DialogTitle, a8 as DialogDescription, B as Button } from "./router-B__nZi39.js";
...
import { d as deleteFromBucket, R as RichTextEditor, u as uploadToBucket } from "./RichTextEditor-Bu2pbsrW.js";
...
function BlogPostEditor({ open, onOpenChange, specialistId, userId, editing, allowAuthorPick = false }) {
  ...
  const handleCover = async (file) => {
    ...
    try {
      ...
      const url = await uploadToBucket("blog-media", userId, file, "cover-");
      setCoverUrl(url);
    } catch (e) {
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex-1 space-y-2", children: [
            ...
            /* @__PURE__ */ jsx(
              Textarea,
              {
                ...
                maxLength: 2e3,
                placeholder: "Ответ",
                onChange: (e) => setFaq((f) => f.map((it, idx) => idx === i ? { ...it, answer: e.target.value } : it))
              }
            )
          ] }),
          /* @__PURE__ */ jsx(
