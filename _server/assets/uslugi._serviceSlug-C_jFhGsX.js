...
import { u as useLeadRequest, f as catalogQuery, B as Button, S as SITE_URL, a7 as Route, a8 as serviceBySlugQuery } from "./router-BmDCopUW.js";
...
function ServiceDetailPage({ service }) {
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxs("section", { className: "relative overflow-hidden", children: [
      /* @__PURE__ */ jsx("div", { className: "absolute inset-0 -z-10 gradient-mesh opacity-70 hidden md:block" }),
      /* @__PURE__ */ jsx("div", { className: "absolute -left-32 top-20 -z-10 h-96 w-96 rounded-full bg-primary/30 blur-3xl orb-1 hidden md:block" }),
      /* @__PURE__ */ jsx("div", { className: "absolute -right-32 top-40 -z-10 h-96 w-96 rounded-full bg-accent/25 blur-3xl orb-2 hidden md:block" }),
      /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-[1100px] px-4 py-20 text-center md:px-8 md:py-28", children: [
        ...
        /* @__PURE__ */ jsx("h1", { className: "mt-6 text-4xl font-extrabold leading-tight md:text-5xl lg:text-6xl", children: service.hero_h1?.trim() ? heroTitle : /* @__PURE__ */ jsxs(Fragment, { children: [
          service.name,
          " в ",
...
function ServiceRouteComponent() {
  ...
  if (!data) return null;
  return /* @__PURE__ */ jsx(ServiceDetailPage, { service: data }, serviceSlug);
}
export {
