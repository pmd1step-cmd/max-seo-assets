...
import { H3Event, toResponse, parseCookies, setCookie } from "h3-v2";
import { rootRouteId, createRawStreamRPCPlugin, invariant, isNotFound, isRedirect, resolveManifestAssetLink, createSerializationAdapter, isResolvedRedirect, executeRewriteInput } from "@tanstack/router-core";
import { F as FrameType, a as FRAME_HEADER_SIZE, g as getDefaultSerovalPlugins, X as X_TSS_SERIALIZED, T as TSS_CONTENT_TYPE_FRAMED_VERSIONED, b as TSS_FORMDATA_CONTEXT, s as safeObjectMerge, c as X_TSS_RAW_RESPONSE, d as TSS_SERVER_FUNCTION, f as flattenMiddlewares, e as createNullProtoObject } from "./vendor-@tanstack-start-client-core-C41cjU9Y.js";
...
import { r as runWithStartContext, g as getStartContext } from "./vendor-@tanstack-start-storage-context-DgH9hIJT.js";
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-DCndt43f.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BwrB5FOf.js").then((n) => n.ax),
    import("./vendor-@tanstack-react-start-T6E7bpAZ.js").then((n) => n.s),
