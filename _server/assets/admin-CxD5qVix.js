...
import { ab as Route, ac as moderationCountsQuery } from "./router-CIs2RZvb.js";
...
function AdminLayout() {
  ...
  if (!auth.isReady) {
    return /* @__PURE__ */ jsx("div", { className: "flex min-h-[40vh] items-center justify-center", children: /* @__PURE__ */ jsx(Loader2, { className: "animate-spin text-primary", size: 28 }) });
  }
  const {
    data: counts
