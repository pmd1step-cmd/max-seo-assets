...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-Bh5a0zTP.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-C7PFiMKM.js").then((n) => n.au),
    import("./vendor-@tanstack-react-start-D7XyjVLZ.js").then((n) => n.a),
