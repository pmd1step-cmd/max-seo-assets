...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-D4J9OTlq.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-D_x5CnOI.js").then((n) => n.au),
    import("./vendor-@tanstack-react-start-BVV9Eizj.js").then((n) => n.a),
