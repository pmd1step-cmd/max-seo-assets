...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-Ybpkdhac.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-Dn0X0tIv.js").then((n) => n.av),
    import("./vendor-@tanstack-react-start-BgOlRn6E.js").then((n) => n.a),
