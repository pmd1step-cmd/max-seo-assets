...
import { n as Route, o as categoryBySlugQuery, c as categoriesQuery, f as catalogQuery, p as PER_PAGE, q as slugsToIds, B as Button } from "./router-COYVRa-T.js";
...
function SpecialistsCategoryPage() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-[1280px] px-4 py-10 md:px-8 md:py-14", children: [
    ...
    /* @__PURE__ */ jsxs(Reveal, { as: "h1", y: 12, className: "text-3xl font-extrabold md:text-5xl", children: [
