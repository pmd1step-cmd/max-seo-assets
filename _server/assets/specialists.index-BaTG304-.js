...
import { e as Route, c as categoriesQuery, g as slugsToIds, i as catalogQuery, P as PER_PAGE, B as Button } from "./router-DuTJZkD0.js";
...
function SpecialistsIndexPage() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-[1280px] px-4 py-10 md:px-8 md:py-14", children: [
    ...
    /* @__PURE__ */ jsxs("h1", { className: "text-3xl font-extrabold md:text-5xl", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "mt-8 grid gap-8 lg:grid-cols-[280px_1fr]", children: [
      ...
      /* @__PURE__ */ jsxs("section", { children: [
        ...
        result.items.length === 0 ? /* @__PURE__ */ jsxs("div", { className: "glass rounded-2xl p-12 text-center", children: [
          ...
          // Убрана тройная вложенность Reveal (Reveal-grid > Reveal-item >
          // Reveal внутри карточки) — каждый Reveal даёт will-change:transform,
          // на 12 карточках мобильный композитор задыхался.
          /* @__PURE__ */ jsx("div", { className: "grid gap-5 md:grid-cols-2", children: result.items.map((s) => /* @__PURE__ */ jsx(SpecialistCard, { specialist: s }, s.id)) })
        ),
