...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-Cir8yS58.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-Bes4cunC.js").then((n) => n.aw),
    import("./vendor-@tanstack-react-start-DU-hPA2a.js").then((n) => n.a),
