...
import { C as ConsentCheckbox, B as Button, s as supabase, U as useAuth, a7 as Route, a8 as specialistBySlugQuery, a9 as specialistCasesQuery, aa as specialistReviewsQuery, ab as specialistBlogPostsQuery } from "./router-C7PFiMKM.js";
import { B as BlogCard } from "./BlogCard-BsRLzmQP.js";
import { r as reviewsWord, y as yearsWord, a as formatPriceRange, f as formatDate } from "./format-CdVWScmC.js";
...
function SpecialistPage() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-[1280px] px-4 py-10 md:px-8 md:py-14", children: [
    ...
    /* @__PURE__ */ jsxs("nav", { className: "mb-4 text-sm text-muted-foreground", children: [
      /* @__PURE__ */ jsx(Link, { to: "/", className: "hover:text-foreground", children: "Главная" }),
      /* @__PURE__ */ jsx("span", { className: "mx-2", children: "/" }),
      /* @__PURE__ */ jsx(Link, { to: "/specialists", className: "hover:text-foreground", children: "Каталог" }),
      /* @__PURE__ */ jsx("span", { className: "mx-2", children: "/" }),
      /* @__PURE__ */ jsx("span", { className: "text-foreground", children: spec.name })
    ] }),
