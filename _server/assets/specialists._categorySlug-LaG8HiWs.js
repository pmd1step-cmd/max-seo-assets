...
import { m as Route, n as categoryBySlugQuery, c as categoriesQuery, f as catalogQuery, o as PER_PAGE, p as slugsToIds, B as Button } from "./router-DeAkxk-P.js";
import { useNavigate, Link } from "@tanstack/react-router";
import { R as Reveal } from "./reveal-6p_yWVuP.js";
import { useSuspenseQuery } from "@tanstack/react-query";
import { useState } from "react";
import { Filter, X, ChevronDown } from "lucide-react";
import { S as SpecialistCard } from "./SpecialistCard-ris4hWOQ.js";
...
function SpecialistsCategoryPage() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-[1280px] px-4 py-10 md:px-8 md:py-14", children: [
    /* @__PURE__ */ jsxs("nav", { className: "mb-4 text-sm text-muted-foreground", children: [
      ...
      /* @__PURE__ */ jsx(Link, { to: "/specialists", className: "hover:text-foreground", children: "Специалисты" }),
      /* @__PURE__ */ jsx("span", { className: "mx-2", children: "/" }),
      /* @__PURE__ */ jsx("span", { className: "text-foreground", children: category?.name ?? params.categorySlug })
    ] }),
