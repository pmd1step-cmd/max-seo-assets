...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-BZs6avox.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-h2CY4Crv.js").then((n) => n.aw),
    import("./vendor-@tanstack-react-start-BazlcY6n.js").then((n) => n.a),
