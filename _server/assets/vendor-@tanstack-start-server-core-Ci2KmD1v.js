...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-BaJGFBGe.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-DeAkxk-P.js").then((n) => n.au),
    import("./vendor-@tanstack-react-start-G02ALtU4.js").then((n) => n.a),
