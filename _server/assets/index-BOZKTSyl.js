...
import { c as categoriesQuery, d as categoryCountsQuery, f as featuredSpecialistsQuery, a as servicesQuery, u as useLeadRequest, B as Button } from "./router-jfBiQfL2.js";
import { S as SpecialistCard } from "./SpecialistCard-D0D9rBII.js";
import "react";
...
function HomePage() {
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsxs("section", { className: "relative overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "absolute -left-32 top-20 -z-10 hidden h-96 w-96 rounded-full bg-primary/30 blur-3xl orb-1 md:block" }),
      /* @__PURE__ */ jsx("div", { className: "absolute -right-32 top-40 -z-10 hidden h-96 w-96 rounded-full bg-accent/25 blur-3xl orb-2 md:block" }),
      /* @__PURE__ */ jsx("div", { className: "absolute left-1/3 top-80 -z-10 hidden h-80 w-80 rounded-full bg-primary-glow/25 blur-3xl orb-3 md:block" }),
      /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-[1280px] px-4 py-20 text-center md:px-8 md:py-32", children: [
        ...
        /* @__PURE__ */ jsxs("h1", { className: "mt-6 text-4xl font-extrabold leading-tight md:text-6xl lg:text-7xl", children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "mx-auto mt-6 max-w-2xl text-base text-muted-foreground md:text-lg", children: "Реклама, рассылки, воронки и SMM под задачи бизнеса. Подберем исполнителей и доведем до результата." }),
